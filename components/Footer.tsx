        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-gray-400 mb-4 text-sm sm:text-base">
              Professional industrial flooring solutions with quality guarantee and multilingual support.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm sm:text-base">
              <li className="flex items-center text-gray-400">
                ...
                <a href="tel:+74951234567" className="hover:text-orange-500 transition-colors cursor-pointer">
                  +7 (495) 123-45-67
                </a>
              </li>
              <li className="flex items-center text-gray-400">
              ...
              <li className="flex items-start text-gray-400">
                ...
                <span>123 Industrial Ave, Moscow, Russia</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              />
              <button className="bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 transition-colors cursor-pointer whitespace-nowrap text-sm">
                Subscribe
              </button>
            </div>
          </div>
